    ...
    <b-card header="오늘 해야 할 일" style="max-width: 40rem; margin: auto; margin-top: 10vh;" class="mb-2" border-variant="info" align="left">
      <b-form-group id="to-do-input">
        <b-container fluid>
          <b-row class="my-1">
            <b-col sm="10">
              <b-form-input v-model="newToDoItemRequest.title" type="text" placeholder="새 할 일을 적으세요." v-on:keyup.enter="createToDo"/>
            </b-col>
            <b-col sm="2">
      ...
      <b-list-group v-if="toDoItems && toDoItems.length" class="my-1">
        <b-list-group-item
          ...
          <b-col align="right">
            <b-button variant="outline-primary" v-model="toDoItem.id" type="text" v-on:click="deleteToDo(toDoItem)">삭제</b-button>
          </b-col>
        </b-list-group-item>
      </b-list-group>
    </b-card>
